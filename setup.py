...
setup(
    ...
    description=('Next generation Bayesian analysis tools for efficient posterior sampling and '
                 'evidence estimation.'),
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/h3jia/bayesfast',
    license='Apache License, Version 2.0',
    python_requires=">=3.7",
    install_requires=['cython', 'extension-helpers', 'jax>=0.3', 'matplotlib', 'multiprocess',
                      'numdifftools<=0.9.39', 'numpy>=1.17', 'scikit-learn', 'scipy>=1.0',
                      'threadpoolctl'],
